...
var SlideshowLightbox = React.forwardRef(function (props, ref) {
  ...
  var _useState14 = React.useState(props.magnifyingGlass ? props.magnifyingGlass : false),
    magnifyingGlassFeature = _useState14[0];
  var _useState15 = React.useState(props.disableImageZoom ? props.disableImageZoom : false),
    disableZoom = _useState15[0],
    setDisableZoom = _useState15[1];
  var _useState16 = React.useState(props.slideshowInterval ? props.slideshowInterval : 1700),
    slideshowInterval = _useState16[0];
  var _useState17 = React.useState(props.rightArrowStyle ? props.rightArrowStyle : {}),
    rightArrowStyle = _useState17[0];
  var _useState18 = React.useState(props.leftArrowStyle ? props.leftArrowStyle : {}),
    leftArrowStyle = _useState18[0];
  var _useState19 = React.useState(props.roundedImages ? props.roundedImages : false),
    isRounded = _useState19[0],
    setIsRounded = _useState19[1];
  var _useState20 = React.useState(props.showControls ? props.showControls : true),
    showControls = _useState20[0],
    setShowControls = _useState20[1];
  var _useState21 = React.useState(props.showFullScreenIcon ? props.showFullScreenIcon : true),
    displayFullScreenIcon = _useState21[0],
    setDisplayFullScreenIcon = _useState21[1];
  var _useState22 = React.useState(props.showThumbnailIcon ? props.showThumbnailIcon : true),
    displayThumbnailIcon = _useState22[0],
    setDisplayThumbnailIcon = _useState22[1];
  var _useState23 = React.useState(props.showSlideshowIcon ? props.showSlideshowIcon : true),
    setDisplaySlideshowIcon = _useState23[1];
  var _useState24 = React.useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
    displayMagnificationIcons = _useState24[0],
    setDisplayMagnificationIcons = _useState24[1];
  var _useState25 = React.useState(props.nextArrow ? props.nextArrow : null),
    nextArrowElem = _useState25[0];
  var _useState26 = React.useState(props.imageComponent ? props.imageComponent : null),
    isImageComponent = _useState26[0];
  var _useState27 = React.useState(props.prevArrow ? props.prevArrow : null),
    prevArrowElem = _useState27[0];
  var _useState28 = React.useState(props.modalClose ? props.modalClose : "default"),
    modalCloseOption = _useState28[0];
  var _useState29 = React.useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState29[0];
  var _useState30 = React.useState(props.rtl ? props.rtl : false),
    isRTL = _useState30[0];
  var _useState31 = React.useState(props.framework ? props.framework : ''),
    frameworkID = _useState31[0];
  var _useState32 = React.useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState32[0];
  var _useState33 = React.useState(props.fullScreen ? props.fullScreen : false),
    imageFullScreen = _useState33[0];
  var _useState34 = React.useState(props.licenseKey ? props.licenseKey : '');
  var _useState35 = React.useState(props.showLoader ? props.showLoader : false),
    displayLoader = _useState35[0],
    setDisplayLoader = _useState35[1];
  var _useState36 = React.useState(props.backgroundColor ? props.backgroundColor : themes[defaultTheme].background),
    backgroundColor = _useState36[0],
    setBackgroundColor = _useState36[1];
  var _useState37 = React.useState(props.iconColor ? props.iconColor : null),
    iconColor = _useState37[0],
    setIconColor = _useState37[1];
  var _useState38 = React.useState(props.textColor ? props.textColor : themes[defaultTheme].textColor),
    textColor = _useState38[0],
    setTextColor = _useState38[1];
  var _useState39 = React.useState(props.useCoverMode ? props.useCoverMode : false),
    coverMode = _useState39[0];
  var _useState40 = React.useState(props.thumbnailBorder ? createCustomThumbnailBorder() : themes[defaultTheme].thumbnailBorder),
    thumbnailBorder = _useState40[0];
  var _useState41 = React.useState(props.showThumbnails ? props.showThumbnails : false),
    showThumbnails = _useState41[0],
    setShowThumbnails = _useState41[1];
  var _useState42 = React.useState(props.animateThumbnails ? props.animateThumbnails : true),
    animatedThumbnails = _useState42[0];
  var _useState43 = React.useState(props.imgAnimation ? props.imgAnimation : 'imgDrag'),
    setImgAnimation = _useState43[1];
  var _useState44 = React.useState(props.arrowStyle ? props.arrowStyle : 'dark'),
    arrowStyle = _useState44[0];
  var _useState45 = React.useState(false),
    setYTVideoCurrentlyPlaying = _useState45[1];
  var _useState46 = React.useState(0),
    width = _useState46[0],
  ...
  var _useState54 = React.useState({}),
...
var AnimImage = function AnimImage(props) {
  ...
  var _useState10 = React.useState(props.lightboxImgClass ? props.lightboxImgClass : ""),
    lightboxImgClassName = _useState10[0];
  var _useState11 = React.useState(props.className ? props.className : ""),
    imgClass = _useState11[0];
  var _useState12 = React.useState(props.showMagnificationIcons ? props.showMagnificationIcons : true),
    displayMagnificationIcons = _useState12[0],
    setDisplayMagnificationIcons = _useState12[1];
  var _useState13 = React.useState(props.showControls ? props.showControls : true),
    displayControls = _useState13[0],
    setDisplayControls = _useState13[1];
  var _useState14 = React.useState(props.downloadImages ? props.downloadImages : false),
    showDownloadBtn = _useState14[0];
  var _useState15 = React.useState(props.rtl ? props.rtl : false);
  var _useState16 = React.useState(props.lightboxIdentifier ? props.lightboxIdentifier : false),
    lightboxIdentifier = _useState16[0];
  var _useState17 = React.useState(props.framework ? props.framework : ''),
